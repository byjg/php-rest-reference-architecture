...
See [JWT Advanced Guide](../guides/jwt-advanced.md) for customizing JWT claims.
...
- [JWT Authentication Advanced Guide](../guides/jwt-advanced.md)
- [REST API Development & OpenAPI Integration](../guides/rest-controllers.md)
